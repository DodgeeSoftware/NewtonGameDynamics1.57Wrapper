#include "PhysicsRayFurthest.h"

unsigned PhysicsRayFurthest::userRayPrefilterCallback(const NewtonBody* pNewtonBody, const NewtonCollision* collision, void* userData)
{
...
float PhysicsRayFurthest::userRayFilterCallback(const NewtonBody* pNewtonBody, const dFloat* hitNormal, int collisionID, void* pUserData, dFloat intersetParam)
{
    ...
    PhysicsRayFurthest* pPhysicsRayFurthest = (PhysicsRayFurthest*)(pUserData);
    // save the ray vector
    impactData.setRayVector(pPhysicsRayFurthest->getRayVector());
