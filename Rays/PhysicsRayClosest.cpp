#include "PhysicsRayClosest.h"

unsigned PhysicsRayClosest::userRayPrefilterCallback(const NewtonBody* pNewtonBody, const NewtonCollision* collision, void* userData)
{
...
float PhysicsRayClosest::userRayFilterCallback(const NewtonBody* pNewtonBody, const dFloat* hitNormal, int collisionID, void* pUserData, dFloat intersetParam)
{
    ...
    PhysicsRayClosest* pPhysicsRayClosest = (PhysicsRayClosest*)(pUserData);
    // save the ray vector
    impactData.setRayVector(pPhysicsRayClosest->getRayVector());
